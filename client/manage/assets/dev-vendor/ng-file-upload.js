...
var angularFileUpload = angular.module('ng-file-upload', ['restangular']);
...
angularFileUpload.directive('ngFileSelect', [ '$parse', '$http', '$timeout', 'Restangular', function($parse, $http, $timeout, Restangular) {
	return function(scope, elem, attr) {
		...
		elem.bind('change', function(evt) {
            ...
            Restangular.one('services', 'upload').get().then(function(resp) {
                $timeout(function() {
                    fn(scope, {
                        $files : files,
                        $resp : resp,
...
angularFileUpload.directive('ngFileDrop', [ '$parse', '$http', '$timeout', 'Restangular', function($parse, $http, $timeout, Restangular) {
	return function(scope, elem, attr) {
		if ('draggable' in document.createElement('span')) {
